...
# * Trained and projected on the query dataset
# * Trained on the query and projected on both the query and the reference dataset
...
from utils.plot_utils import PCA_trained_and_projected_on_query, PCA_trained_on_query_projected_on_both, PCA_trained_and_projected_on_both
