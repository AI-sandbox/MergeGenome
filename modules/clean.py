...
def clean_genomic_data(reference_paths: List[str], query_paths: List[str], output_folder: str, 
    ...
    Args:
        ...
        remove_sample_ID ((List[str])): list with sample IDs or substring of samples IDs to remove.
    ...
    for reference_path, query_path in zip(reference_paths, query_paths):
        ...
        if remove_sample_ID is not None:
            ...
            reference = filter_samples(reference, remove_sample_ID, logger)
            ...
            query = filter_samples(query, remove_sample_ID, logger)
